...
try {
  ...
  try {
    ...
    try {
      ...
      $isAdmin=$verifiedIdToken->claims()->get('admin');
      $approved = $verifiedIdToken->claims()->get('approved');
      ...
      if($user->emailVerified==true){
        ...
        // $_SESSION["env"]="https://cdrrmo.gov.ph/dms";
         $_SESSION["env"]="http://192.168.1.6/dms2/dms";
            ...
            if($_SESSION["approved"]){
              ...
              $_SESSION['errormessage']="Account not approved yet";
              unset($_SESSION["isAdmin"]);
             header('Location: auth-login-basic.php');
              exit();
            }
      }else{
        $_SESSION['errormessage']="Please verify your email.";
       header("Location: auth-login-basic.php");
        exit();
      }
...
>
  <head>
    ...
    <title>Login - eFileCabinet.gov</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to eFileCabinet.gov</h4>
              <p class="mb-4">Please sign-in to your account to proceed..</p>
